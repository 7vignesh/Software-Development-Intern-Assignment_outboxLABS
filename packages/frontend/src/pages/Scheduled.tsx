...
/**
 * Scheduled emails list view matching Figma design.
 * Shows email rows with To, scheduled time badge (orange), subject, and preview.
 */
...
function EmailRow({ email, type }: { email: EmailJob; type: 'scheduled' | 'sent' }) {
